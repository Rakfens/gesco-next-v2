...
export default function Depenses() {
  ...
  const loadDepenses = useCallback(async () => {
    ...
    try {
      ...
      setDepenses(list);
      calcStats(list);
    } catch (_) { showError('Erreur chargement des dépenses'); }
...
function inp() {
  return { padding: '9px 14px', borderRadius: 8, border: '1px solid var(--border2)', background: 'var(--card)', color: 'var(--text)', fontSize: 13, fontFamily: 'var(--font)', outline: 'none', width: '100%', boxSizing: 'border-box' };
}
