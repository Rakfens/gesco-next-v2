...
// Règles absolues pour imprimante thermique :
//   - ZÉRO fond coloré (background toujours blanc ou transparent)
//   - ZÉRO gris clair (les gris < #666 ne s'impriment pas)
//   - Tout le texte en #000 pur
//   - Police Courier New (machine à écrire) — claire, mono, adaptée ticket
//   - Séparateurs en tirets ASCII plutôt que border coloré
//   - Taille mini 11px (9px illisible sur thermique)
const THERMAL_CSS = `
