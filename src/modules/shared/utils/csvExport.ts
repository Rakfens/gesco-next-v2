  ...
  data.forEach(row => {
    const csvRow = headers.map(header => {
      ...
      if (typeof value === 'object' && value !== null) {
        value = (value as Record<string, unknown>).label || (value as Record<string, unknown>).name || JSON.stringify(value);
      }
...
export const exportLivraisonsToCSV = (livraisons: Record<string, unknown>[], companyName: string = 'aterinay'): void => {
...
export const exportAgentsToCSV = (agents: Record<string, unknown>[], companyName: string = 'aterinay'): void => {
...
export const exportAvancesToCSV = (avances: Record<string, unknown>[], companyName: string = 'aterinay'): void => {
...
export const exportRecuperationsToCSV = (recuperations: Record<string, unknown>[], companyName: string = 'aterinay'): void => {
...
export const exportProduitsToCSV = (produits: Record<string, unknown>[], companyName: string = 'commerce'): void => {
...
export const exportVentesToCSV = (ventes: Record<string, unknown>[], companyName: string = 'commerce'): void => {
...
export const exportAchatsToCSV = (achats: Record<string, unknown>[], companyName: string = 'commerce'): void => {
...
export const exportDepensesToCSV = (depenses: Record<string, unknown>[], companyName: string = 'pomanay'): void => {
...
export const exportStockToCSV = (produits: Record<string, unknown>[], companyName: string = 'commerce'): void => {
