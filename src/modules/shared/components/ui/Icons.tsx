...
// SVG icons used across the app — extracted from layout to avoid duplication
...
// Navigation icons
export type NavIconKey = 'grid' | 'truck' | 'clock' | 'user' | 'chart' | 'users' | 'refresh' | 'cash' | 'cart' | 'box' | 'list' | 'wallet' | 'document';
