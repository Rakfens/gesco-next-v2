    ...
    <div ref={dropdownRef} style={{ position: 'relative' }}>
      <button
        ...
        style={{
          ...
          padding: '6px 12px', background: getCompanyColor(),
      ...
      {isOpen && (
        <div style={{
          ...
          borderRadius: '8px', minWidth: '220px', zIndex: 1000,
            ...
            return (
              ...
              >
                <span style={{ width: 24, height: 24, borderRadius: 6, background: companyColor, color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 9, fontWeight: 700, flexShrink: 0 }}>
                  {company.slug === 'pomanay' ? 'POM' : company.slug === 'zazatiana' ? 'ZAZ' : 'LIV'}
                </span>
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: '13px', fontWeight: isActive ? 600 : 400 }}>{company.name}</div>
