...
export default function Historique() {
  ...
  const totalMontant = livsFiltered.filter(l => l.paiement !== 'client').reduce((s, l) => s + (Number(l.montant) || 0), 0);
  const totalFrais = livsFiltered.reduce((s, l) => s + (Number(l.frais) || 0), 0);
