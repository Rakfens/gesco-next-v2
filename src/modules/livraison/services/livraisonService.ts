...
export const addLivraison = async (
...
export const fetchLivraisonsByStatut = async (
  statut: string,
  companyId: string,
): Promise<Livraison[]> => {
  if (!companyId) return [];
...
export const fetchLivraisonsByAgent = async (
  agentId: string,
  companyId: string,
): Promise<Livraison[]> => {
  if (!companyId) return [];
...
export const fetchLivraisonsByDate = async (
  date: string,
  companyId: string,
): Promise<Livraison[]> => {
  if (!companyId) return [];
