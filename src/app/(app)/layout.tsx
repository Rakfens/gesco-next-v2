...
const navGroups: NavGroup[] = [
  ...
  },
  {
    title: "Templates",
    items: [
      { label: "Facture", href: "/templates/facture", icon: <IconFileText /> },
      { label: "Devis", href: "/templates/devis", icon: <IconFile /> },
      { label: "Bon livraison", href: "/templates/bon-livraison", icon: <IconTruck /> },
    ],
  },
  {
    title: "Livraison",
